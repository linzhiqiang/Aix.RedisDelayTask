...
namespace Aix.RedisDelayTask.Impl
{
    public class DelayTaskConsumer
    {
        ...
        CancellationToken StoppingToken => _delayTaskLifetime.ScheduleTaskStopping;
            ...
            await _redisStorage.Lock(lockKey, lockTimeSpan, async () =>
            {
                ...
                foreach (var item in list)
                {
                    ...
                    if (taskData == null)
                    {
                        ...
                        await _redisStorage.RemoveNullDealyTask(_delayTopicName, jobId);
                    }
        ...
        private async Task HandleRetry(TaskData taskData)
        {
            ...
            {
                var delaySecond = GetDelaySecond(taskData.ErrorRetryCount);
